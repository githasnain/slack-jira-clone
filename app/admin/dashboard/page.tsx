      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Welcome, {session.user?.name || session.user?.email}! Manage your workspace.
          </p>
        </div>
            ...
            <div className="p-6">
              <div className="space-y-3">
                <button 
                  ...
                  className="w-full text-left px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-dark-700 rounded-lg border border-gray-200 dark:border-gray-600"
                >
                  <div className="flex items-center">
                ...
                >
                  <div className="flex items-center">
                    ...
                    Manage Projects & Channels
                  </div>
                </button>
                <button className="w-full text-left px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-dark-700 rounded-lg border border-gray-200 dark:border-gray-600">
                  <div className="flex items-center">
                    <svg className="w-5 h-5 mr-3 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    User <strong>admin@workspace.com</strong> logged in successfully
                  </p>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    New user <strong>user5@workspace.com</strong> created
                  </p>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Project <strong>Web Application</strong> status updated
                  </p>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg font-medium text-gray-900 dark:text-white">API</h4>
